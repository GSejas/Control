// ======================================================================
// IDAC8(SAR-POT).v generated from TopDesign.cysch
// 04/17/2016 at 11:33
...
// IDAC8_v2_0(Current=100, Data_Source=0, Hardware_Enable=false, IDAC_Range=4, IDAC_Speed=2, Initial_Value=100, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_1, CY_INSTANCE_SHORT_NAME=IDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=IDAC8_1, )
module IDAC8_v2_0_0 (
    iOut,
    data,
    strobe,
...
module top ;
    ...
    defparam IDAC8_1.Initial_Value = 100;
	...
	cy_psoc3_pins_v1_10
		#(.id("b46d5392-bfd1-4519-9b63-d1678025640f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
