// ======================================================================
// CE95358.v generated from TopDesign.cysch
// 04/08/2016 at 11:43
...
// CharLCD_v2_0(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=0, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=CharLCD_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=LCD, )
...
// ADC_SAR_v2_10(ADC_Clock=1, ADC_Clock_Frequency=1800000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_Resolution_HW=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v2_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_0, CY_INSTANCE_SHORT_NAME=ADC_SAR_0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=ADC_SAR_0, )
module ADC_SAR_v2_10_2 (
    vplus,
    vminus,
    soc,
    eoc,
...
module top ;
	...
	wire [0:0] tmpOE__potenciometro_net;
	wire [0:0] tmpFB_0__potenciometro_net;
	wire [0:0] tmpIO_0__potenciometro_net;
	wire [0:0] tmpINTERRUPT_0__potenciometro_net;
	electrical [0:0] tmpSIOVREF__potenciometro_net;
	...
	cy_psoc3_pins_v1_10
		...
		potenciometro
		 (.oe(tmpOE__potenciometro_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__potenciometro_net[0:0]}),
		  .analog({Net_17}),
		  .io({tmpIO_0__potenciometro_net[0:0]}),
		  .siovref(tmpSIOVREF__potenciometro_net),
		  .interrupt({tmpINTERRUPT_0__potenciometro_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__potenciometro_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
